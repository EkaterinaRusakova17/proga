...
namespace Dixotomia
{
    public partial class Form3 : Form, IView
    {
        ...
        double IView.leftLimit()
        { 
            return Convert.ToDouble(leftLimit.Text); 
        }
        double IView.rightLimit() 
        { 
            return Convert.ToDouble(rightLimit.Text); 
        }
        ...
        {
            byte choice = 1;
            if (radioButtonPeresech.Checked)
            {
                choice = 1;
            }
            else if (rbtnMin.Checked)
            {
                choice = 2;
            }
        ...
        void IView.ShowResult(double result, double functionResult)
        {
            ...
            else
            {
                ...
                else if (radioButtonPeresech.Checked)
                {
